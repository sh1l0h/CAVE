...
void chunk_thread_pool_init()
{
    ...
    array_list_create(&chunk_thread_pool->results, sizeof(struct ChunkThreadResult), 1024);
...
void chunk_thread_pool_apply_results()
{
    ...
    struct ChunkThreadResult *results = (struct ChunkThreadResult *) chunk_thread_pool->results.data;
